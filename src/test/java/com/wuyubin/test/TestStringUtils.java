 ...
 * 
 * @Test public void testRandomn() { String s = StringUtils.getRandomStr(10);
 * System.out.println(" s is :: " + s); }
 * 
 * @Test public void testStrRland() { String s = StringUtils.getRandomStr2(25);
 * System.out.println(" s is " + s + "  and ������  " + s.length()); }
 * 
 * 
 * @Test public void testCnStrn() { String s = StringUtils.getRandomCnn(25);
 * System.out.println(" s " + s + "  changdu : " + s.length());
 * 
 * }
 * 
 * @Test public void testNumCnStrn() { boolean b = StringUtils.isNum("2-");
